    ...
    <div class="mainCONTent">
        <div class="container">
            ...
            <div class="d-flex justify-content-center align-items-center flex-column py-2 ">
                  @csrf
                <h2 class="CLAIM">Complaint Submission Form</h2>
                <p class="WARENTTEXT">If the vendor didn't consider the repair service, you have the option to file a complaint to the admin. Please use the form below to submit your complaint. Our admin team will review your complaint and take appropriate action.</p>
            </div>
            <form action="{{ route('submit.complaint') }}" method="POST" class="d-flex flex-column py-5">
                @csrf
                <div class="d-flex flex-column " style="margin-bottom: 2rem">

                   <label class="FORMSLABELD py-1 " for="">Full Name</label>
                <input class="WARENTTEXT BORDERD py-3 px-2 bg-transparent " type="text" placeholder="Name Here " name="full_name">
                </div>
                ...
                <div  class="py-2" >
                    ...
                    <p class="text-muted mt-2">Please select the store where you faced the issue or want to submit the complaint. This helps us in directing your complaint to the appropriate team for resolution.</p>
                </div>
                </div>
                ...
                <div class="d-flex flex-column " style="margin-bottom: 2rem">
                    <label class="FORMSLABELD py-1 pt-2" for="">Subject</label>
                    <input class="WARENTTEXT BORDERD py-3 px-2 bg-transparent " type="text" placeholder="Subject" name="subject">
                </div>

                <label class="FORMSLABELD py-1 pt-2" for="">Complaint Details</label>
                <textarea class="WARENTTEXT BORDERD py-3 pb-5 px-2 bg-transparent " rows="5" placeholder="Enter details of your complaint here" name="complaint_details"></textarea>

                <p class="WARENTTEXT">Our team will contact you soon regarding your complaint.</p>
