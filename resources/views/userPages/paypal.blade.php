        ...
        <div class="row gx-3">
            <div class="col-12">
                <div class="d-flex flex-column">
                    ...
                    <input class="form-control mb-3" type="text" placeholder="Name" value="{{ $cart->user->name }}">
                </div>
            </div>
            <div class="col-12">
            <div class="d-flex flex-column">
                    <p class="text mb-1">Products</p>
                    {{-- <input class="form-control mb-3" type="text" placeholder="1234 5678 435678"> --}}
                    @foreach($cartproducts as $cartItem)
                    <input class="form-control mb-3" type="text" placeholder="{{ $cartItem->product->name }}" value="{{ $cartItem->product->name }}">
